...
int cout =
    0; // won't compile if headers don't follow convention regarding namespaces
...
int main(int argc, char **argv) {
  ...
  {
    seneca::Rogue<seneca::SuperHealth, seneca::Heal, seneca::Fireball> ch_1(
        "Quick Silver", 950, 33, 77);
    seneca::Rogue<double, seneca::Fireball, seneca::Fireball> ch_2(
        "Rogue Ronin", 800, 50, 50);
    seneca::Rogue<seneca::InfiniteHealth, seneca::Bersek, seneca::Bersek> ch_3(
        "Ghost Blade", 20, 10, 1);

    seneca::Archer<seneca::Crossbow> ch_4("Lethal Bunny", 1000, 200, 111,
                                          seneca::Crossbow{124});
    seneca::Archer<seneca::Crossbow> ch_5("Nova Burst", 1234, 150, 123, {});
    seneca::Archer<seneca::Bow> ch_6("Kill Switch", 2000, 222, 67,
                                     seneca::Bow{210});

    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_7(
        "Master Chief", 1000, 100, 10, seneca::Sword{23}, seneca::Sword{20});
    seneca::Barbarian<double, seneca::Heal, seneca::Axe> ch_8(
        "Mercy Less", 1200, 80, 8, {}, {});
    seneca::Barbarian<seneca::InfiniteHealth, seneca::Fireball,
                      seneca::BareHands>
        ch_9("Mecha Doom", 100, 50, 0, {}, {});
    seneca::Barbarian<double, seneca::Fireball, seneca::Sword> ch_10(
        "Flame Princess", 100, 100, 100, {}, {});

    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_11(
        "Big Boss", 50, 200, 23, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_12(
        "Loot Goblin", 60, 180, 34, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_13(
        "Toxic Terror", 70, 160, 45, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_14(
        "Plasma Cannon", 80, 140, 56, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_15(
        "Nebula", 90, 120, 67, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_16(
        "Tomb Raider", 100, 100, 78, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_17(
        "Last Guardian", 110, 80, 89, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_18(
        "Serpent King", 120, 60, 101, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_19(
        "Morpheus", 130, 40, 112, {}, {});
    seneca::Barbarian<double, seneca::Bersek, seneca::Sword> ch_20(
        "Razor Sharp", 140, 20, 123, {}, {});

    team_1.addMember(&ch_1);
    team_1.addMember(
        &ch_1); // attempting to add again the same item; should not add
    team_1.addMember(&ch_2);
    team_1.addMember(&ch_4);
    team_1.addMember(&ch_7);
    team_1.addMember(&ch_9);
    team_1.addMember(
        &ch_9); // attempting to add again the same item; should not add

    team_2.addMember(&ch_3);
    team_2.addMember(&ch_5);
    team_2.addMember(&ch_6);
    team_2.addMember(
        &ch_6); // attempting to add again the same item; should not add
    team_2.addMember(&ch_8);
    team_2.addMember(&ch_10);

    // local scope ends here, all `ch_*` characters will go out of scope
    //   This should cause no problem because the would have already made
    //   copies.
  }
...

  {
    ...
    std::cout << "==========:==========:==========:==========:==========\n";
    guild_1.addMember(team_1[2]); // the health of this character should be
                                  // increased when in a guild
    guild_1.addMember(
        team_1[2]); // attempting to add again the same item; should not add
