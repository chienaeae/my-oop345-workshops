...
template <typename T> static void loadFromFile(const char *, std::vector<T> &);
...
int main(int argc, char **argv) {
...

  {
    ...
    std::cout << "getNextSerialNumber(): "
              << theStations[0].getNextSerialNumber() << std::endl;
    std::cout << "getNextSerialNumber(): "
              << theStations[0].getNextSerialNumber() << std::endl;
...

  {
    ...
    std::cout << "isOrderFilled(): "
              << (tmp2.isOrderFilled() ? "FILLED" : "MISSING") << std::endl;

    tmp2.fillItem(theStations[0], std::cout);
    std::cout << "isItemFilled(\"CPU\"): "
              << (tmp2.isItemFilled("CPU") ? "FILLED" : "MISSING") << std::endl;
